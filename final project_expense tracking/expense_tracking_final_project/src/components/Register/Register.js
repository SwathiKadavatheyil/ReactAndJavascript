...
function Register(){
    ...
    const onSubmitHandler=(event)=>{
      ...
      setValidation({
        ...
        password:!passwordValidation(getForm.password)?"Please provide the correct password. Min 10 characters and should include 1 uppercase, 1 lowercase, 1 number and 1 special character":''
      })
                ...
                <div className="col-4">
                  <form id="registrationForm" action="login.html">
                      ...
                      <div className="form-group">
                        ...
                        {getValidation.password && <div style={{fontSize:"8px"}} className="alert alert-danger" role="alert">
                        {getValidation.password}
                      </div>}
                      </div>
                      <div align="center">
                        <button id="signUp" onSubmit={onSubmitHandler} onClick={onSubmitHandler} type="submit" className="btn btn-primary" style={{borderRadius:"20px",paddingLeft:"50px",paddingRight:"50px"}}>Sign Up</button>
                      </div>
